...
import { addVoucher } from "../../../stores/voucherSlice";

export default function ModalAddVoucher({ setOpenModal }) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      Discount: Yup.number().required(t("required")).min(0, "Phải là số dương"),
