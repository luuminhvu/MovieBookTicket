...
import { addCinema } from "../../../stores/cinemaSlice";

export default function ModalCreateCinema({ setOpenModal }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        await dispatch(addCinema(values));
        dispatch(setLoading(false));
        setOpenModal(false);
      } catch (error) {
        console.error("Lỗi khi thêm mới rạp chiếu:", error);
      }
    },
  });
