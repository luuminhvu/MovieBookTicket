...
import { addMovie } from "../../../stores/movieSlice";

export default function ModalCreateMv({ setOpenModal }) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      ReleaseDate: Yup.string().required(t("required")),
      Description: Yup.string().required(t("required")),
      Genres: Yup.string().required(t("required")),
      Directors: Yup.string().required(t("required")),
      Actors: Yup.string().required(t("required")),
    ...
    onSubmit: async (values) => {
      try {
        ...
        console.error("Lỗi khi thêm mới bộ phim:", error);
      }
    },
  });
