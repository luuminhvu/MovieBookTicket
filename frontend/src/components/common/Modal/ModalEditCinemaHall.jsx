...
import { editCinemaHall } from "../../../stores/cinemaSlice";
export default function ModalEditCinemaHall({ setOpenModal, row }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        await dispatch(
          editCinemaHall({ ...values, CinemaHallID: row.CinemaHallID })
        );
        dispatch(setLoading(false));
        setOpenModal(false);
      } catch (error) {
        console.error("Lỗi khi chỉnh sửa phòng chiếu:", error);
      }
    },
  });
