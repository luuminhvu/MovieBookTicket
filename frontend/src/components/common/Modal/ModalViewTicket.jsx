...
export function ModalViewTicket({ row, setOpenModal }) {
  const printTicket = () => {
    ...
    html2canvas(ticket).then((canvas) => {
      ...
      pdf.save(`ticket-${row.NumberOfTickets}.pdf`);
    });
  };
  return (
    <div>
          ...
          <div className="relative w-full max-w-lg p-4 mx-auto bg-white rounded-md shadow-lg">
            <div className="mt-3">
              ...
              <div className="mt-2 text-center sm:ml-4 sm:text-left">
                ...
                <div
                  id="ticket"
                  className="mt-3 border border-gray-300 rounded-lg flex"
                >
                ...
                <div className="flex items-center justify-center mt-4">
                  <button
                    onClick={printTicket}
                    className="p-2.5 text-white bg-red-600 rounded-md outline-none ring-offset-2 ring-red-600 focus:ring-2"
                  >
                    In vé
                  </button>
                </div>
