        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-lg text-gray-500 lg:mx-auto">
              Tại Cinema, chúng tôi cam kết mang đến cho bạn những trải nghiệm
              xem phim đáng nhớ. Với cơ sở vật chất hiện đại và một loạt các bộ
              phim, chúng tôi nhằm mục tiêu biến mỗi lần ghé thăm Cinema trở nên
              đặc biệt.
            </p>
          </div>
            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Cinema mang đến một trải nghiệm xem phim độc đáo, với cơ sở
                  vật chất hiện đại và một loạt các bộ phim phong phú phù hợp
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Cinema cam kết cung cấp giá cả cạnh tranh để đảm bảo mọi người
                  có thể thưởng thức phép màu của điện ảnh mà không phải lo lắng
                  về tài chính.
                </dd>
              </div>
              <div className="relative">
